...
namespace NitroCast.Core.TypeConverters
{
	...
	/// </summary>
	public class ClassFolderBuilderConverter : StringConverter
	{
		// Source DataTypes Collection
        private static List<ClassFolderBuilder> builders;

        public static void Init(List<ClassFolderBuilder> builders)
		{
            ClassFolderBuilderConverter.builders = builders;
		}
