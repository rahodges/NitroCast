...
namespace NitroCast.Core.TypeConverters
{
	...
	/// </summary>
	public class ValueTypeBuilderConverter : StringConverter
	{
        // Source DataTypes Collection
        private static List<ValueTypeBuilder> builders;

        public static void Init(List<ValueTypeBuilder> builders)
        {
            ValueTypeBuilderConverter.builders = builders;
        }
