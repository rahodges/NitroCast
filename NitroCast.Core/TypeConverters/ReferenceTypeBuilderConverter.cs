...
namespace NitroCast.Core.TypeConverters
{
	...
	/// </summary>
	public class ReferenceTypeBuilderConverter : StringConverter
	{
		// Source DataTypes Collection
        private static List<ReferenceTypeBuilder> builders;

        public static void Init(List<ReferenceTypeBuilder> builders)
		{
            ReferenceTypeBuilderConverter.builders = builders;
		}
