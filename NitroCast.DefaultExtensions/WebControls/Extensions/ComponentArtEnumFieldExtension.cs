...
{
    public class ComponentArtEnumFieldExtension : EnumFieldExtension
    {
        string cssClass;
        ...
        public ComponentArtEnumFieldExtension()
            : base()
        {
            cssClass = "comboBox";
        ...
        public static ComponentArtEnumFieldExtension Find(EnumField f)
        {
            return (ComponentArtEnumFieldExtension)
